...
namespace Nexora.Infrastructure.Migrations
{
    ...
    [Migration("20260710054750_AddDeviceSystemLogs")]
    partial class AddDeviceSystemLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexora.Domain.Entities.DeviceSystemLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("device_system_logs", (string)null);
                });
            ...
            modelBuilder.Entity("Nexora.Domain.Entities.SavedCard", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Nexora.Domain.Entities.SavedCard", b =>
                {
                    b.HasOne("Nexora.Domain.Entities.Landlord", "Landlord")
                        .WithOne()
                        .HasForeignKey("Nexora.Domain.Entities.SavedCard", "LandlordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
